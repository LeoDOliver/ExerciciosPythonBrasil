...
if media >= 9.0 and media <= 10:
    print(f"Suas notas foram {nota1} e {nota2}, a média é {media}, seu conceito é A e você está APROVADO (A)")
elif media >= 7.5 and media <9.0:
    print(f"Suas notas foram {nota1} e {nota2}, a média é {media}, seu conceito é B e você está APROVADO (A)")
elif media >= 6.0 and media < 7.5:
    print(f"Suas notas foram {nota1} e {nota2}, a média é {media}, seu conceito é C e você está APROVADO (A)")
elif media >= 4.0 and media < 6.0:
    print(f"Suas notas foram {nota1} e {nota2}, a média é {media}, seu conceito é D e você está REPROVADO (A)")
elif media >= 0 and media < 4.0:
    print(f"Suas notas foram {nota1} e {nota2}, a média é {media}, seu conceito é E e você está REPROVADO (A)")
else:
    print("Valor invalido")
